...
const ROOT_URL = 'https://nightlife-ps-serv.herokuapp.com';
...
export function handleUserAuthentication(signinType, {email, password, firstname, lastname}) {
    ...
    return axios.post(`${ROOT_URL}/${signinType}`, { email, password, firstname, lastname })
      .then(response => {
        // If request is good...
      ...
      .catch((response) => {
          if (response.status === 400) {
            dispatch(authError('Please enter credentials'))
